...
import (
	...
	appshares "github.com/rollchains/tiablob/celestia/shares"
...
func (msg *MsgPayForBlobs) ValidateBasic() error {
	...
	hrp, _, err := bech32.DecodeAndConvert(msg.Signer)
	if err != nil {
		return err
	}

	if hrp != "celestia" {
		return fmt.Errorf("invalid signer bech32 prefix %s, expected celestia", hrp)
	}
